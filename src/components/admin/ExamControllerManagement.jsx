    ...
    <Box>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Manage ExamC ontroller and assign rooms dynamically
          </Typography>
        </Box>
      ...
      <Paper sx={{ p: 2, mb: 3 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          <TextField
            fullWidth
            placeholder="Search Exam Controller by name, email, or phone..."
            value={searchTerm}
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="sm" fullWidth>
        <DialogTitle>Add New Exam Controller</DialogTitle>
        <DialogContent>
      ...
      <Dialog open={editDialogOpen} onClose={() => setEditDialogOpen(false)} maxWidth="sm" fullWidth>
        <DialogTitle>Edit Exam Controller</DialogTitle>
        <DialogContent>
...
export default ExamControllerManagement;